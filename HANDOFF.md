...
v105 已在独立分支 `codex/v105-handoff-local-20260910` 接收并完成本地复测，生产已按用户授权切换到独立源目录 `deploy-v105-409a5e5`；API、worker healthy，scheduler running，v1.0.4 源目录、镜像和精确回滚 Compose 保留。
...
本包基线为 `46c713d4a7f6f247461ec9b075948f25c6741df7`；部署前代码 HEAD 为 `409a5e5`，最终文档收口提交为 `a7c464e`，应用包版本仍为1.0.4。接收分支已推送远端，`main` 未合并、标签未移动。

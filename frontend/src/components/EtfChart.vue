...
onBeforeUnmount(()=>{++mountRevision;adapter?.destroy();adapter=null;document.removeEventListener('keydown',escape);document.removeEventListener('fullscreenchange',fullscreenChanged);document.removeEventListener('pointerdown',outside);window.removeEventListener('resize',positionIndicators);window.removeEventListener('scroll',positionIndicators,true);window.visualViewport?.removeEventListener('resize',positionIndicators);window.visualViewport?.removeEventListener('scroll',positionIndicators)})
</script>

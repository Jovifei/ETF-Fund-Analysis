...
describe('one ETF route and bookmark compatibility', () => {
  ...
  it('keeps old paths as redirects rather than duplicate pages', () => { for (const path of ['/legacy', '/workbench/1430', '/workbench/kline', '/system', '/research', '/matrix', '/classic/etf-board', '/boards', '/decision/1430']) expect(router.resolve(path).matched[0].redirect).toBeTruthy() })

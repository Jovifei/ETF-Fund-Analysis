...
AKSHARE_APIS = frozenset({
    ...
    'stock_zh_index_daily_em','index_zh_a_hist','stock_zh_index_daily_tx','stock_zh_a_hist_tx','index_us_stock_sina','stock_news_em','stock_info_global_em','stock_info_global_sina',

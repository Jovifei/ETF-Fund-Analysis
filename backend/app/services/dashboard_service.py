            ...
            rows.append(
                {
                    ...
                    "quote": {
                        ...
                        "source_timestamp": quote.quote_time,
                    ...
                    "indicator": {
                        ...
                        "feature_schema_version": indicator.feature_schema_version,
                        "config_hash": indicator.config_hash,
                        "git_commit_sha": indicator.git_commit_sha,
                        "values": values,
                    }
                    if indicator
                    else None,
                    "forecasts": {
                        str(horizon): {
                            ...
                            "q50": item.q50,
                            "q90": item.q90,
                            "terminal_price_q10": item.terminal_price_q10,
                            "terminal_price_q50": item.terminal_price_q50,
                            "terminal_price_q90": item.terminal_price_q90,
                            "path_low_price_q10": item.path_low_price_q10,
                            "path_low_price_q50": item.path_low_price_q50,
                            "path_low_price_q90": item.path_low_price_q90,
                            "path_high_price_q10": item.path_high_price_q10,
                            "path_high_price_q50": item.path_high_price_q50,
                            "path_high_price_q90": item.path_high_price_q90,
                            "corridor_position": item.corridor_position,
                            "support_touch_probability": item.support_touch_probability,
                            "resistance_touch_probability": item.resistance_touch_probability,

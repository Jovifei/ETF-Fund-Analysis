...
本地收据保留当时 SQLite 副本的 v101 price-only 事实；生产反馈复测发现新浪历史接口的 `volume/amount` 与收盘价单位可校验，已在独立提交 `208858e` 升级为 v102 来源。生产维护窗口重抓 35 个标的后，成交量缺失为 0、指标 35/35 更新到 2026-09-11，决策板 `数据异常=0`。这项生产复测不倒写本地副本，也未修改历史数据库日期。

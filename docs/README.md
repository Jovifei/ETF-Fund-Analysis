...
- [v105 公网部署收据](PRODUCTION_DEPLOYMENT_RECEIPT_V105_20260911.md)：生产备份、诊断端口、回滚材料、容器切换、公开 health、认证边界和数据持久性复核。
...
- [v1.0.4 公网生产部署收据](PRODUCTION_DEPLOYMENT_RECEIPT_V104_20260910.md)：刷新根因、备份、切换/回滚、容器健康和真实生产数据时间戳。
